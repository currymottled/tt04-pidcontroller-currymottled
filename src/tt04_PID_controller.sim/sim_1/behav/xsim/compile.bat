...
REM
REM Generated by Vivado on Tue Sep 05 01:02:46 -0600 2023
...
echo "xvlog --incr --relax -prj RepeatedAdder_tb_vlog.prj"
call xvlog  --incr --relax -prj RepeatedAdder_tb_vlog.prj -log xvlog.log
